...
def public_liam_flags() -> dict:
    ...
    return {
        ...
        'visual_panel_enabled': enabled and _bool('LIAM_VISUAL_PANEL_ENABLED', True),
        'search_enabled': enabled and _bool('LIAM_SEARCH_ENABLED', True),
        'actions_enabled': enabled and _bool('LIAM_ACTIONS_ENABLED', True),
        'admin_enabled': enabled and _bool('LIAM_ADMIN_ENABLED', True),
        'dev_enabled': enabled and _bool('LIAM_DEV_ENABLED', False),
        'repair_enabled': enabled and _bool('LIAM_REPAIR_ENABLED', False),
