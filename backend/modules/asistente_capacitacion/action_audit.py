...
def list_authorized(database_path,ctx,limit=50,offset=0):
    ...
    try:
        ...
        return {'scope':{'foundation_id':tenant,'cross_foundation':False},'total':total,'limit':limit,'offset':offset,'has_more':offset+len(rows)<total,'actions':rows,'technical_details_included':False}
    finally:conn.close()
