...
RULES = {
    ...
    'download_ram': ActionRule('download_ram','generation',ALL_AUTHENTICATED,'explicit',False),
    'publish_master_database': ActionRule('publish_master_database','modification',frozenset({'SUPERADMIN','GERENTE'}),'explicit',False),
    'replace_master_database': ActionRule('replace_master_database','critical',frozenset({'SUPERADMIN'}),'reauthentication',False),
    'create_user': ActionRule('create_user','administration',frozenset({'SUPERADMIN'}),'explicit',False),
    'update_user': ActionRule('update_user','administration',frozenset({'SUPERADMIN'}),'explicit',False),
    'delete_user': ActionRule('delete_user','critical',frozenset({'SUPERADMIN'}),'reauthentication',False),
    'create_foundation': ActionRule('create_foundation','administration',frozenset({'SUPERADMIN'}),'explicit',False),
    'update_foundation': ActionRule('update_foundation','administration',frozenset({'SUPERADMIN'}),'explicit',False),
