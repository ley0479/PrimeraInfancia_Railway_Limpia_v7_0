...
RULES = {
    ...
    'prepare_dev_sandbox_plan': ActionRule('prepare_dev_sandbox_plan','generation',frozenset({'SUPERADMIN'})),
    ...
    'restore_backup': ActionRule('restore_backup','critical',frozenset({'SUPERADMIN'}),'reauthentication'),
    ...
    'safe_repair_preview': ActionRule('safe_repair_preview','read',frozenset({'SUPERADMIN'})),
    'safe_repair_apply': ActionRule('safe_repair_apply','critical',frozenset({'SUPERADMIN'}),'explicit'),
