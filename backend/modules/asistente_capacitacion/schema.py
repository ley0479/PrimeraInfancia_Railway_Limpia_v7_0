...
CREATE TABLE IF NOT EXISTS liam_action_audit (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE INDEX IF NOT EXISTS idx_liam_action_audit_scope
ON liam_action_audit(fundacion_id, usuario_id, created_at);
