...
def relacion_mes_generar():
    ...
    headers = [
        ...
        'TOTAL HUEVOS (UNIDADES)', 'CUBETAS DE 30', 'PANALES COMPLETOS (7 CUBETAS)',
    ...
    ws.cell(2, 1).value = 'Regla: 30 huevos por usuario; 6 a 11 meses recibe 15. Una cubeta contiene 30 huevos y un panal contiene 7 cubetas. La entrega se separa en panales completos más cubetas sueltas, sin redondear.'
